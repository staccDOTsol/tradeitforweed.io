            ...
            <Segment color='blue'>
                ...
                <Segment padded basic>
                    ...
                    <p style={{fontSize: '1.33em'}}>
                        Forums have a <strong>10 SMOKE</strong> initial creation fee. No other fees are required after this. The hosting and upgrade costs of the forum are increased by the beneficary rewards generated though activity within the forum itself.
                    </p>
                    <p>
                        ...
                        <Grid.Row>
                            <Grid.Column width={8}>
                                <Header size='large'>
                                    Blockchain Powered
                                    <Header.Subheader>
                                        All data exists on the Smoke blockchain
                                    </Header.Subheader>
                                </Header>
                                <p style={{fontSize: '1.33em'}}>
                                    The BtsTalk forum engine is powered by the <a href='https://smoke.io'>Smoke</a> blockchain. This means your data is uncorruptable and forever permanant. Every post, vote, and action anyone takes within a BtsTalk forum happens on this blockchain. If the BtsTalk servers are ever corrupted, they can easily be rebuild by replaying the blockchain.
                                </p>
                            </Grid.Column>
                            <Grid.Column width={6} floated='right'>
                                <a href='https://smoke.io'>
