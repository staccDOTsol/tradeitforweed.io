                        ...
                        <Grid>
                            <Grid.Row>
                                <Grid.Column width={10}>
                                    ...
                                    <p>If the details of this reservation look correct - complete the transaction below and send {forum_creation_cost} SMOKE to confirm your reservation.</p>
                                    <Table definition verticalAlign='top'>
                                        <Table.Body>
                                            ...
                                            <Table.Row>
                                                ...
                                                <Table.Cell>{forum_creation_cost} SMOKE</Table.Cell>
                                            </Table.Row>
                                            <Table.Row>
