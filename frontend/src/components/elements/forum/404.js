    ...
    if(!forum.exclusive) {
        tagUsage = (
            <div>
                ...
                <p>
                    If you'd like to post to this forum from another SMOKE powered application, please make sure to use one of the following tags as the first tag in your post:
                </p>
                <List>
