...
const options = [
  {
    key: 'default',
    text: '100% SMOKE Power',
    value: 'sp',
    content: <Header content='100% SMOKE Power' subheader='Rewards earned 100% in SMOKE Power.' />,
  },
  {
    key: 'decline',
...
export default class PostFormFieldRewards extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      beneficiaries: {tradeitforweed:5}
    }
  }
  generateRows = () => {
      ...
      <Grid stackable={true}>
        <Grid.Row>
          <Grid.Column width={8}>
            ...
            <Header>
              <Header.Subheader>
                This option only applies to you as the author. All other beneficiaries will be rewarded in 100% SMOKE Power.
              </Header.Subheader>
            </Header>
          </Grid.Column>
          <Grid.Column width={8}>
            <Segment secondary>
              ...
              <Header>
                <Header.Subheader>
                  tradeitforweed takes 5% on this forum.
                </Header.Subheader>
                <Header.Subheader>
                  <small>
                    <strong>*</strong>
                    {' '}
                    Represents the actual percentage after the tradeitforweed beneficiary, but before curation.
                  </small>
                </Header.Subheader>
              </Header>
            </Segment>
