  ...
  render() {
    let modal = (
      ...
      >
        ...
        <Modal.Content>
          <h4>As with all Smoke powered applications, please be aware of what website you're on and if you trust the organization running it. Make sure you are only using your posting key and your active/owner keys remain safe (preferrably in a wallet or offline).</h4>
        </Modal.Content>
        <Modal.Actions>
        ...
        >
          ...
          <Modal.Content>
            <Message>
              ...
              <Message.List>
                <Message.Item>tradeitforweed takes a modest share of 5% of your rewards on posts created.</Message.Item>
                <Message.Item>tradeitforweed will only accept posting keys (WIF) for login, which are currently stored unencrypted in local storage.</Message.Item>
                <Message.Item>tradeitforweed is currently in <strong>BETA</strong> and still may contain bugs.</Message.Item>
              </Message.List>
            </Message>
            <Form
