    ...
    if ( height > height_processed + 30) {
      ...
      warning = (
        <Container style={{margin: '0.5em 0 1em'}}>
          <Message warning>
            <Icon name='warning' />
            tradeitforweed is currently <strong>{blocksBehind} blocks</strong> (<TimeAgo date={timeBehind} />) behind on syncronization due to networking issues. This may cause a delay in your actions displaying on tradeitforweed.io/.
          </Message>
        </Container>
      )
    }
